					...
					<div class="col-md-6">
						...
						<div class="ismobileProd">
							...
							<div class="product-btns">
								...
								<button v-on:click="slickGo" class="primary-btn add-to-cart"><i class="fa fa-shopping-cart"></i> Add to Cart</button>
...
methods:{
	...
	callService : function(){
		var _this = this;
		_this.product = false
		this.reqData("getProduct", {props : this.$route.params['id']}, function(store){_this.slickActivate(); _this.product = store.product})
	},
