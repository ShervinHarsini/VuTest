...
require_once $_SERVER['DOCUMENT_ROOT'] . "/test/MicroDB/Event.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/test/MicroDB/Cache.php";
require_once $_SERVER['DOCUMENT_ROOT'] . "/test/MicroDB/index.php";
